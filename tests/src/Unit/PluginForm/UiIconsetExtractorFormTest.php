...
/**
 * Tests UiIconsetExtractorForm pluginForm.
 *
 * @group ui_icons
 */
class UiIconsetExtractorFormTest extends UnitTestCase {
  ...
  protected function setUp(): void {
    ...
    $this->uiIconsetForm = new UiIconsetExtractorForm();
    $this->uiIconsetForm->setPlugin($this->plugin);
  }
  ...
  public function testBuildConfigurationForm() {
    ...
    $result = $this->uiIconsetForm->buildConfigurationForm($form, $formState);
  ...
  public function testValidateConfigurationForm() {
    ...
    $this->uiIconsetForm->validateConfigurationForm($form, $formState);
  ...
  public function testSubmitConfigurationForm() {
    ...
    $this->uiIconsetForm->submitConfigurationForm($form, $formState);
